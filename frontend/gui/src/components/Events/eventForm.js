            ...
            <div className="row">
                ...
                <p className="col">
                    <span className="bio-label">
                        {(props.bio.phy !== undefined) ? Math.round(props.bio.phy * 100) : 0}%
                    </span>
                </p>
            </div>
            <div className="row">
                ...
                <p className="col">
                    <span className="bio-label">
                        {(props.bio.emo !== undefined) ? Math.round(props.bio.emo * 100) : 0}%
                    </span>
                </p>
            </div>
            <div className="row">
                ...
                <p className="col">
                    <span className="bio-label">
                        {(props.bio.int !== undefined) ? Math.round(props.bio.int * 100) : 0}%
                    </span>
                </p>
            </div>
        </div>
